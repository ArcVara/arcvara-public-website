...
export default function DataRights() {
  ...
  const sections = t('legal.dataRights.sections', { returnObjects: true })
  ...
  return (
    <div className="min-h-screen bg-navy text-white">
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        ...
        <h1 className="text-4xl font-bold text-white mb-2">{t('legal.dataRights.title')}</h1>
            ...
            <LegalSection key={i} title={section.title}>
              ...
              {section.requestBox && (
                <div className="bg-navy-card border border-arc-blue/15 rounded-xl p-5 my-4">
                  <p className="text-white/80 font-medium mb-1">{section.requestBox.title}</p>
                  <a href="mailto:jawad.a.almarhoon@gmail.com" className="text-vara-teal hover:underline text-sm">
                    jawad.a.almarhoon@gmail.com
                  </a>
                  <p className="text-white/40 text-xs mt-2">{section.requestBox.note}</p>
                </div>
              )}
